			...
			<div class="top-wrapper">
				...
				<ul id="loginmenu" class="block_hlist">
					...
					--%>
					 ...
					 <%--   
					 	Spring에서도 JSTL 처럼 View 에서 사용할 수 있는 script를 가지고 있다 
					 --%>
					 ...
					 <!-- pageContext.request.userPrincipal.name 이거와  property="name" 같은 뜻이다 -->
					 <se:authentication property="name" var="loginuser"/>
					 <se:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_USER')">
					 	<li><a href="${pageContext.request.contextPath}/logout">(${loginuser})님 로그아웃</a></li>
					 </se:authorize>
